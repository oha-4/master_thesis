...
ベンチマーク問題として，同期構造や規模の異なる8つのシナリオを用意し，既存手法および提案手法における探索状態数と計算時間を比較する．
各シナリオにおいて問題を段階的にスケールさせ，計27個のテストケースを用いて定量的な評価を行う．
...
各シナリオにおいて，コンポーネント数やリソース容量などのパラメータ $N$ を変化させることで問題規模を拡大し，合計27個のテストケースを作成した．
...
本シナリオは，物流倉庫における商品搬送システムであるKiva Systemをモデル化した問題である~\cite{KivaSystemScenario}．
